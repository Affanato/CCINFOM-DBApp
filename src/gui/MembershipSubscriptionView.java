 ...
 * @author Diane
 */
public class MembershipSubscriptionView extends JFrame {
	public MembershipSubscriptionView() {
		initComponents();
	}
	...
	public void membershipBackButtonListener(ActionListener actionListener) {
		this.membershipBack.addActionListener(actionListener);
	}

	public void recordSubscriptionButtonListener(ActionListener actionListener) {
		this.recordSubscriptionButton.addActionListener(actionListener);
	}

	// getters
	public JFrame getMembershipFrame() {
		return this.membershipFrame;
	}

	public String getMemberID() {
		return this.memberID.getText();
	}
	...
	public void setMemberTableData(Object[][] data, String[] columnNames) { 
		DefaultTableModel model = new DefaultTableModel(data, columnNames);
